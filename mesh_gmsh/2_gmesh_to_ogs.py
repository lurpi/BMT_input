...
ifilename="FM_3d_extrusion_spacing_corrected.mesh" #generated from .geo file, having physical volumes defined before than surfaces (needed with material_ID)
ofilename="OGS_taskB.msh"
