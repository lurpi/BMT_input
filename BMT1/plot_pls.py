...
r2="taskB-3d_time_MONITORING2.tec"
...
ax2.plot(X, P0, 'r.', lw=1.5,label='Strain at inj.point_03')
ax2.plot(X2, P2, 'b-', lw=2.5,label='Strain at P3')
ax2.plot(X_f2, P_f2, 'g-', lw=2.5,label='Strain at 18cm below')
...
ax2.set_ylabel('STRAIN_PLS', fontsize=28)
