...
sxx0= p0["STRESS_XX"].values
syy0= p0["STRESS_YY"].values
szz0= p0["STRESS_ZZ"].values
sxz0= p0["STRESS_XZ"].values
syz0= p0["STRESS_YZ"].values
dxt = p0["DISPLACEMENT_X1"].values
dyt = p0["DISPLACEMENT_Y1"].values
dzt = p0["DISPLACEMENT_Z1"].values
dx0 = p0["DISPLACEMENT_X1"].values-dxt[1]
dy0 = p0["DISPLACEMENT_Y1"].values-dyt[1]
dz0 = p0["DISPLACEMENT_Z1"].values-dzt[1]
...
point_out=[]
point_out.append("Output P1 injection point ")
